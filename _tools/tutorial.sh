...
echo ""
echo ""
echo -e "  ${BOLD}Don't fill it in manually — just talk to the agent.${RESET}"
echo -e "  Say: ${DIM}\"Let's fill in my profile\"${RESET} — it will ask about your"
echo -e "  background and write personal/profile.md from the conversation."
...
echo ""
echo -e "    1.  Open Claude Code and say: ${DIM}\"Let's fill in my profile\"${RESET}"
echo -e "        The agent will ask about you and write personal/profile.md for you."
