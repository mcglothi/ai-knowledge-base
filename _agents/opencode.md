...
`python3 /home/tmcglothin/code/AIKB/_tools/memory-pipeline/runtime_cli.py wake-up --agent "OpenCode"`
...
1. Preferred: add to `~/.zshrc`: `source /home/tmcglothin/code/AIKB/_tools/memory-pipeline/opencode-wrapper.sh`
...
`python3 /home/tmcglothin/code/AIKB/_tools/memory-pipeline/runtime_cli.py im send --from "OpenCode" --to "OpenCode" --severity info --summary "<subject>" --body "<detail>" --mirror-sent`
