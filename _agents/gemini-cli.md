...
Sync: `cp /home/tmcglothin/code/AIKB/_agents/gemini-cli.md ~/.gemini/GEMINI.md`
...
`python3 /home/tmcglothin/code/AIKB/_tools/memory-pipeline/runtime_cli.py wake-up --agent "Gemini CLI"`
...
`python3 /home/tmcglothin/code/AIKB/_tools/memory-pipeline/runtime_cli.py im send --from "Gemini CLI" --to "Gemini CLI" --severity info --summary "<subject>" --body "<detail>" --mirror-sent`
