...
`python3 /home/tmcglothin/code/AIKB/_tools/memory-pipeline/runtime_cli.py wake-up --agent "Claude Code"`
...
`python3 /home/tmcglothin/code/AIKB/_tools/memory-pipeline/runtime_cli.py im send --from "Claude Code" --to "Claude Code" --severity info --summary "<subject>" --body "<detail>" --mirror-sent`
...
Before compact: `python3 /home/tmcglothin/code/AIKB/_tools/memory-pipeline/runtime_cli.py capture --agent "Claude Code" --session-id <id> --type decision --summary "<what>" [--rejected "<alt>"] [--assumptions "<ctx>"] [--invariants "<incomplete>"] [--next-step "<next>"]`
